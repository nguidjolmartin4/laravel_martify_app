            ...
            <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                ...
                <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
                    ...
                    <form>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="hs-firstname-contacts-1" id="hs-firstname-contacts-1"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-md focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                        ...
                        <div class="mt-4 grid">
                            <button type="submit"
                                class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-md font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Send
                                inquiry</button>
                        </div>
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="flex gap-x-7 py-6">
                        ...
                        <div class="grow">
                            ...
                            <p class="mt-1 text-md text-gray-500">We're here to help with any questions or code.</p>
                            <a class="mt-2 inline-flex items-center gap-x-2 text-md font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                                href="#">
                                Contact support
                    ...
                    <div class="flex gap-x-7 py-6">
                        ...
                        <div class="grow">
                            ...
                            <p class="mt-1 text-md text-gray-500">Search our FAQ for answers to anything you might ask.
                            </p>
                            <a class="mt-2 inline-flex items-center gap-x-2 text-md font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                                href="#">
                                Visit FAQ
                    ...
                    <div class=" flex gap-x-7 py-6">
                        ...
                        <div class="grow">
                            ...
                            <p class="mt-1 text-md text-gray-500">Check out our development quickstart guide.</p>
                            <a class="mt-2 inline-flex items-center gap-x-2 text-md font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                                href="#">
                                Contact sales
                                <svg class="shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1 group-focus:translate-x-1"
                    ...
                    <div class=" flex gap-x-7 py-6">
                        ...
                        <div class="grow">
                            ...
                            <p class="mt-1 text-md text-gray-500">If you wish to write us an email instead please use
                            </p>
                            <a class="mt-2 inline-flex items-center gap-x-2 text-md font-medium text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                                href="#">
                                example@site.com
