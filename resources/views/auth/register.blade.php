<x-form>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div
            class="fixed top-4 left-4 z-50 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 shadow-lg w-full max-w-xs md:max-w-md lg:max-w-lg">
            @if ($errors->any())
                <div class="flex p-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                    ...
                    <div>
                        <span class="font-medium">There were some errors during registration : </span>
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="post"
                        ...
                        <div class="flex flex-col md:flex-row md:space-x-4">
                            <div class="w-full">
                                ...
                                <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}"
                                    ...
                                    placeholder="Clotaire" required autocomplete="cc-family-name">
                            </div>
                            <div class="w-full">
                                <label for="last_name"
                                ...
                                <input type="text" name="last_name" id="last_name" value="{{ old('last_name') }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Hotarien" required autocomplete="cc-given-name">
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="newsletter" class="font-light text-gray-500 dark:text-gray-300">I wish
                                    to
