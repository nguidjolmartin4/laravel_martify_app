<div class="bg-white">
    ...
    <header class="relative bg-white">
        <p
            class="flex h-10 items-center justify-center bg-indigo-600 px-4 text-md font-medium text-white sm:px-6 lg:px-8">
                    ...
                    <div class="hidden lg:ml-8 lg:block lg:self-stretch">
                        <div class="flex h-full space-x-8">
                            <div class="flex">
                                ...
                                <div class="absolute inset-x-0 top-full text-md text-gray-500">
                            ...
                            <a href="#"
                                class="flex items-center text-md font-medium text-gray-700 hover:text-gray-800">Company</a>
                            <a href="#"
                                class="flex items-center text-md font-medium text-gray-700 hover:text-gray-800">Stores</a>
                        </div>
                    </div>
