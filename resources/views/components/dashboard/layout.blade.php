            ...
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                        ...
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Martify</span>
                    </a>
                </div>
                <div class="flex items-center lg:order-2">
                    ...
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full" src="{{ asset('storage/' . $user->profile_picture) }}"
                            alt="user photo" />
                    </button>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li>
                                <a href="#"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Option
                                    1</a>
                            </li>
                            <li>
                                <a href="#"
