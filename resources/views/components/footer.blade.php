    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div class="col-span-full hidden lg:col-span-1 lg:block">
            <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80"
                href="{{ route('home') }}" aria-label="Brand">Martify Online Shopping</a>
            <p class="mt-3 text-xs sm:text-md text-gray-600">Copyright © 2024 Martify All rights reserved.</p>
        </div>
        ...
        <div>
            ...
            <div class="mt-3 grid space-y-3 text-md">
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        href="#">About us</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        href="#">Blog</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
        ...
        <div>
            ...
            <h4 class="mt-7 text-xs font-semibold text-gray-900 uppercase">Resources</h4>
            <div class="mt-3 grid space-y-3 text-md">
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
                        href="#">Community</a></p>
                <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800"
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
            <div class="flex flex-wrap items-center gap-3">
                <div class="hs-dropdown [--placement:top-left] relative inline-flex">
                    ...
                    <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2"
                        ...
                        <a class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-md text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                            href="#">
            ...
            <div class="flex flex-wrap justify-between items-center gap-3">
                <div class="mt-3 sm:hidden">
                    <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80"
                        href="#" aria-label="Brand">Martify Online Shopping</a>
                    <p class="mt-1 text-xs sm:text-md text-gray-600">Copyright © 2024 Martify All rights reserved.</p>
                </div>
