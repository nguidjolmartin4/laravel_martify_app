<section class="bg-white py-8 antialiased  md:py-16">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
            ...
            <a href="#" title=""
                class="flex items-center text-base font-medium text-primary-700 hover:underline ">
                See more categories
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <a href="#"
                ...
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 15v5m-3 0h6M4 11h16M5 15h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v9a1 1 0 0 0 1 1Z">
                    </path>
                </svg>
                <span class="text-md font-medium text-gray-900 ">Computer & Office</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-md font-medium text-gray-900 ">Collectibles & Toys</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-md font-medium text-gray-900 ">Books</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-md font-medium text-gray-900 ">Fashion/Clothes</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-md font-medium text-gray-900 ">Sports & Outdoors</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="text-md font-medium text-gray-900 ">Painting & Hobby</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                    viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 9a3 3 0 0 1 3-3m-2 15h4m0-3c0-4.1 4-4.9 4-9A6 6 0 1 0 6 9c0 4 4 5 4 9h4Z"></path>
                </svg>
                <span class="text-md font-medium text-gray-900 ">Electronics</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Food & Grocery</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Music</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">TV/Projectors</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Health & beauty</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Home Air Quality</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Gaming/Consoles</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Car & Motorbike</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Photo/Video</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Security & Wi-Fi</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Computer Peripherals</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Phone Accessories</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Watches</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Printers</span>
            </a>
            ...
            <a href="#"
                ...
                <span class="text-md font-medium text-gray-900 ">Projectors</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
                ...
                <span class="text-md font-medium text-gray-900 ">Skin Care</span>
            </a>
            <a href="#"
                class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 ">
                <svg class="me-2 h-4 w-4 shrink-0 text-gray-900 " aria-hidden="true"
            ...
            <a href="#"
                ...
                <span class="text-md font-medium text-gray-900 ">Office Supplies</span>
            </a>
        </div>
    </div>
</section>
