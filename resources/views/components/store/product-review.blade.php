        ...
        <div class="my-6 gap-8 sm:flex sm:items-start md:my-8">
            <div class="shrink-0 space-y-4">
                ...
                <button type="button" data-modal-target="review-modal" data-modal-toggle="review-modal"
                    class="mb-2 me-2 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Write
                    a review</button>
            </div>
            ...
            <div class="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
                <div class="flex items-center gap-2">
                    ...
                    <a href="#"
                        class="w-8 shrink-0 text-right text-sm font-medium leading-none text-blue-700 hover:underline dark:text-blue-500 sm:w-auto sm:text-left">239
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="#"
                        class="w-8 shrink-0 text-right text-sm font-medium leading-none text-blue-700 hover:underline dark:text-blue-500 sm:w-auto sm:text-left">432
                        <span class="hidden sm:inline">reviews</span></a>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="#"
                        class="w-8 shrink-0 text-right text-sm font-medium leading-none text-blue-700 hover:underline dark:text-blue-500 sm:w-auto sm:text-left">53
                        <span class="hidden sm:inline">reviews</span></a>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="#"
                        class="w-8 shrink-0 text-right text-sm font-medium leading-none text-blue-700 hover:underline dark:text-blue-500 sm:w-auto sm:text-left">32
                        <span class="hidden sm:inline">reviews</span></a>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="#"
                        class="w-8 shrink-0 text-right text-sm font-medium leading-none text-blue-700 hover:underline dark:text-blue-500 sm:w-auto sm:text-left">13
                        <span class="hidden sm:inline">reviews</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
            ...
            <div
                ...
                <div>
                    ...
                    <a href="#" class="font-medium text-blue-700 hover:underline dark:text-blue-500">Apple
