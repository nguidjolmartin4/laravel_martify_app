                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="sr-onlyblock text-md font-semibold text-gray-800 dark:text-neutral-200">{{ $product->id }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                        ...
                                        <td class="h-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-md font-semibold text-gray-800 dark:text-neutral-200">{{ number_format($product->price, 2) }}
                                                    FCFA</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="block text-md font-semibold text-gray-800 dark:text-neutral-200">{{ $product->stock_quantity }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium {{ $product->status == 'available' ? 'bg-teal-100 text-teal-800 dark:bg-teal-500/10 dark:text-teal-500' : 'bg-red-100 text-red-800 dark:bg-red-500/10 ' }} rounded-full">
